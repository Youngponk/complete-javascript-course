...
for (let i = 0; i < books.length; i++) {
  ...
  console.log(
    `${books[i].title} provides no online about its online content`
    );
    }
...
// const [...mainKeyword] = books[0].keywords;
...
//? Aqui se aplica el concepto de destructuración de asignación por eso se rodea en parentesis
